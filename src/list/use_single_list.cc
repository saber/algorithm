...
int main(int argc, char **argv) {
    ...
    // 测试尾部删除、头部删除、普通删除
    cout << endl << "测试尾部删除、头部删除、普通删除!" << endl << "before dele" << endl;
    ...
    // 测试删除重复数据,一些边界条件！！！
    // 普通插入数据
    cout << endl << "测试删除重复数据,一些边界条件！";
    cout << endl << "common insert test!" << endl;
